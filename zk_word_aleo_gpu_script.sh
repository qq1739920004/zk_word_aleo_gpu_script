...
function main_menu() {
    while true; do
        ...
        echo "1. 安装并运行 zkwork_aleo 挖矿程序（v0.2.1)）"
        echo "2. 安装并运行 zkwork_aleo 挖矿程序（v0.2.0)）"
        echo "3. 安装并运行 zkwork_aleo 挖矿程序（v0.1.3-stable)）"
        echo "4. 安装并运行 zkwork_aleo 挖矿程序（v0.1.3-boost,(cpu好选这个）"
        echo "5. 安装并运行 zkwork_aleo 挖矿程序（v0.1.2-stable)）"
        echo "6. 安装并运行 zkwork_aleo 挖矿程序（v0.1.2-pre,(cpu好选这个）"
        echo "7. 安装并运行 zkwork_aleo 挖矿程序（标准版 v0.1.1）"
        echo "8. 安装并运行 zkwork_aleo 挖矿程序（hot 版本 v0.1.1）"
        echo "9. 安装并运行 zkwork_aleo 挖矿程序（hot 版本 v0.1.0）"
        echo "10. 安装并运行 zkwork_aleo 挖矿程序（标准版 v0.1.0）"
        echo "11. 查看挖矿日志"
        ...
        2) install_and_run_miner_v0_2_0 ;;
        3) install_and_run_miner_v0_1_3 ;;
        4) install_and_run_miner_pre_v0_1_3 ;;
        5) install_and_run_miner_v0_1_2 ;;
        6) install_and_run_miner_pre_v0_1_2 ;;
        7) install_and_run_miner_v0_1_1 ;;
        8) install_and_run_hot_miner_v0_1_1 ;;
        9) install_and_run_hot_miner_v0_1_0 ;;
        10) install_and_run_miner_v0_1_0 ;;
        11) view_logs ;;
        12) restart_miner ;;
        13) uninstall_miner ;;
        14) exit 0 ;;
